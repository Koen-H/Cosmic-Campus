...
public class CrystalManager : MonoBehaviour
{
    ...
    private Range emissionRange = new Range(0.005f, 1);

    private void Start()
    {
        startEssence = essence;
        material = GetComponent<Renderer>().material;
        initialEmissionColor = material.GetColor("_EmissiveColor");
        currentEmissionIntensity = material.GetFloat("_EmissiveIntensity");
    }
